    ...
    return (
        <div className='container-fluid footer'>
            <div className="container">
                <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-botton mb-3">
                    ...
                    <div className="col mb-3 mt-4">
                        ...
                        <ul className="nav flex-column mt-5">
                            ...
                            <li className="nav-item mb-2"><Link to="#" className="nav-link p-0  text-white">Services</Link></li>
                            <li className="nav-item mb-2"><Link to="#" className="nav-link p-0  text-white">Gallery</Link></li>
                            <li className="nav-item mb-2"><Link to="#" className="nav-link p-0  text-white">Contact Us</Link></li>
                            <li className="nav-item mb-2"><Link to="#" className="nav-link p-0  text-white">Pediatrics</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="col mb-3 mt-4">
                        ...
                        <ul className="nav flex-column mt-5">
                            <li className="nav-item mb-2"><Link to="#" className="nav-link p-0  text-white mt-3"><span className='fs-3'>Sunday - Friday</span>
                                <br /><span className='fs-5'>08:00 am - 10:00pm</span></Link></li>
                            <li className="nav-item mb-2"><Link to="#" className="nav-link p-0  text-white fs-3">Satarday Closed</Link></li>
                            <li className="nav-item mb-2"><Link to="#" className="nav-link p-0  text-white"><div className='d-flex'>
            ...
            <div className='border-2 border-top  '>
                <p className=" text-white bg-dark container-fluid p-3"><h1 className='fs-4 text-uppercase text-center text-white'>menalwell technologies pvt ltd © 2023</h1></p>
            </div>
        </div>
    )
}
