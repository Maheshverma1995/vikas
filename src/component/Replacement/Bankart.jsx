      ...
      {/* <div className='container'>
        <div className='row'>
          <div className='col-12 pt-100'>
            <img className='w-100' src="./Image/bankart-repair-2.jpg" alt="" />
          </div>
        </div>
      </div> */}
